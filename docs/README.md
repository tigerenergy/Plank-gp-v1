...
이 폴더에는 Plank 프로젝트의 모든 문서가 정리되어 있습니다.
...
### 🎯 프로젝트 현황
- **[PROJECT_STATUS.md](./PROJECT_STATUS.md)** ⭐ **최신** - 구현 완료된 기능 및 구현해야 할 기능 목록
...
- **현재 상태 확인**: [PROJECT_STATUS.md](./PROJECT_STATUS.md) ⭐ **최신**
...
1. 새로운 기능 구현 완료 시: `PROJECT_STATUS.md` 업데이트
2. 문서 정리: 불필요한 문서는 삭제
3. 문서 네이밍: `FEATURE_NAME.md` 형식 사용
