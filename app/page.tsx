  ...
  return (
    <main className='min-h-screen'>
      ...
      <header className='sticky top-0 z-50 bg-bg-primary/80 backdrop-blur-xl border-b border-white/5'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 py-4'>
          <h1 className='text-2xl font-bold text-text-primary'>
            짭렐로 <span className='text-pastel-violet'>✦</span>
          </h1>
        </div>
      </header>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 py-8'>
        ...
        >
          <h2 className='text-xl font-semibold text-text-primary mb-2'>내 보드</h2>
          <p className='text-text-muted'>보드를 선택하거나 새로 만들어보세요</p>
        </motion.div>
