...
제가 직접 실행할 수 있도록 다음 정보를 제공해주세요:

1. **Supabase Project URL**: `https://xxxxx.supabase.co`
2. **Supabase Service Role Key**: `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...` (Settings > API > service_role key)

⚠️ **보안 주의**: Service Role Key는 매우 민감한 정보입니다. 공유 시 주의하세요.
